...
DEPTHAI_ZOO = Path(__file__).parent.parent / Path(f"resources/nn/") #changed back resources/nn/ 
# please dont change this to the exact path resources/nn/yolo-v3-tf/yolo-v3-tf.json
