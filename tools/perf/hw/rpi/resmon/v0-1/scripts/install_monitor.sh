...
Exec=bash -c 'lxterminal --working-directory=/home/finley/Documents/GitHub/Vision/vdepthai -e "bash -c \"source bin/activate && cd /home/finley/Documents/GitHub/Vision/tools/perf/hw/rpi/resmon/v0-1/monitoring/ && chmod +x run_monitor.sh && ./run_monitor.sh; exec bash\""'
Type=Application
Terminal=false
