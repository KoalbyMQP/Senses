...
class Chain:
    ...
    def inverse_kinematics(self, target_position=None, target_orientation=None, orientation_mode=None, initial_position=None, **kwargs):
        """
        ...
        return self.inverse_kinematics_frame(target=frame_target, orientation_mode=orientation_mode, no_position=no_position, initial_position=initial_position, **kwargs)

    def inverse_kinematics_frame(self, target, initial_position, **kwargs):
        ...
        return ik.inverse_kinematic_optimization(self, target, starting_nodes_angles=initial_position,regularization_parameter=.1,**kwargs)
